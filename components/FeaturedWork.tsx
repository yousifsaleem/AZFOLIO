...
function FeaturedTextContent({ project, nextProject }: { project: Project; nextProject: Project }) {
  ...
  return (
    <>
      <div className="flex max-xl:max-w-full items-start xl:absolute xl:left-0 xl:top-[var(--fw-number-y)] xl:w-full">
      ...
      <div className="flex max-xl:max-w-full flex-col gap-6 xl:absolute xl:inset-x-0 xl:top-[var(--fw-tags-y)] xl:gap-6">
              ...
              >
                <div className="absolute left-0 top-0 h-full min-h-screen w-screen overflow-hidden">
                  ...
                  <div className="layout-shell relative z-10 flex min-h-screen items-center py-8 sm:py-10 lg:py-14 xl:items-start xl:py-0">
                    <div
                      className="flex w-full items-center xl:pt-[var(--fw-media-y)]"
                      style={{ marginLeft: "var(--fw-media-x)" }}
                    >
                      <div
                        data-featured-scene-media
                        className="aspect-square w-full max-w-[420px] xl:aspect-[601/549] xl:h-auto xl:w-[min(var(--fw-media-w),calc(var(--fw-media-h)*601/549))] xl:max-w-none"
                      >

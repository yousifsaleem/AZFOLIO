      ...
      {featuredProjects.map((project) => (
        ...
        >
          ...
          <div className="relative z-10 grid min-h-screen w-full gap-10 px-6 py-8 sm:px-8 sm:py-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] lg:px-14 lg:py-14 xl:px-20">
            <div className="flex items-center">
              <div className="w-full max-w-[760px]">
                <div className="relative aspect-[10/8] overflow-hidden rounded-[2rem] border border-white/20 bg-white/10 shadow-[0_24px_80px_rgba(0,0,0,0.28)]">
                  ...
                  <div className="relative flex h-full items-end justify-between p-6 sm:p-8">
            ...
            <div className="grid min-h-[24rem] grid-rows-[1fr_auto_auto] pb-2 lg:min-h-0">
              <div className="flex items-center lg:justify-center">
                <div className="max-w-[30rem] lg:ml-4 xl:ml-10">
                  ...
                  <h2 className="type-display-lg mt-4 text-white">{project.title}</h2>
              ...
              <div className="mt-10 flex items-end justify-start lg:justify-end">
                <Link
